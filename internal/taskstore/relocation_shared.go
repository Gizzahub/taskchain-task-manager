...
func validateSharedRelocation(s sharedState) error {
	...
	if (s.StorageProtocol != 2 && s.StorageProtocol != 3) || s.Phase != "active" || s.PendingRepair != nil || s.PendingBundle != nil || s.PendingArchive != nil || (s.Policy != nil && s.Policy.Phase != "active") {
