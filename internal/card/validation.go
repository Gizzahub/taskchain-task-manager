...
func (d *Document) ValidateCard(path string, r ValidationRules) (ValidationReport, error) {
	report := ValidationReport{Scope: outputvocab.ScopeCard, BoardValidation: outputvocab.NotEvaluated, Valid: true, Criteria: []CriterionReport{}, Findings: []ValidationFinding{}}
